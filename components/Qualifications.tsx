...
export default function Qualifications() {
  ...
  const qualifications: Qualification[] = [
    ...
    },
    {
      name: 'AtCoder',
      level: '茶色',
      date: '2023年7月', // 取得年月を記入
    },
    {
      name: '情報処理安全確保支援士試験',
      date: '2021年12月', // 取得年月を記入
    },
    {
        name: '応用情報技術者試験',
        date: '2017年12月', // 取得年月を記入
      },
    {
      name: '日商簿記3級',
      date: '2017年11月', // 取得年月を記入
    },
    {
        name: 'ITIL Foundation',
        date: '2017年9月', // 取得年月を記入
    },
    ]
      ...
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-3xl mx-auto">
          {qualifications.map((qual, index) => (
            <div
              key={index}
              className="p-6 border border-accent bg-bg-secondary rounded-sm"
            >
